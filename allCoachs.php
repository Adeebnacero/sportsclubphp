   ...
   <body> 
         ...
         <?php            
			...
			{	
				...
				curl_setopt_array($curl, array(
				  CURLOPT_PORT => "8080",
				  CURLOPT_URL => "http://localhost:8080/Controller/allCoachs",
      ...
      <div class= "container-fluid" align="center" >      
         <form class = "form-signin" role = "form" action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = "post">
			<h3 style="margin-top:10px;">All Coach</h3>
			<br clear="both"> 
				<button class = "btnSubmit" type = "submit" name = "view">View Coach</button>
         </form> 		 
      </div>	  
</body>
</html>
