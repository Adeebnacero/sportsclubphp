...
<body> 
			...
			{		
				if(ctype_digit($_POST['ID'])){
					...
					curl_setopt_array($curl, array(
					  CURLOPT_PORT => "8080",
					  CURLOPT_URL => "http://localhost:8080/Controller/deletePlayer?clubID=$id",
      ...
      <div class= "container-fluid" align="center" >      
         <form class = "form-signin" role = "form" action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = "post">
			<h3 style="margin-top:10px;">Players to remove</h3>
			<br clear="both">
				<input type = "ID" class = "form-control" name = "ID" placeholder = "Member ID"  required autofocus style="width:250px;"></br>
				<button class = "btnSubmit" type = "submit" name = "remove">Delete Player</button>
         </form> 		 
      </div>   
